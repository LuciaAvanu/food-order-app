...
export default function MealInfo({ meal }) {
  ...
  return (
    <div className="p-4 min-h-64 rounded-b-lg flex flex-col justify-between items-center text-white bg-slate-800 ">
      ...
      <button className="text-black bg-yellow-400 py-2 px-3 rounded-lg hover:bg-orange-400 hover:text-white" onClick={() => cartCtx.addItemToCart(meal)}>Add to cart</button>
    </div>
  );
}
